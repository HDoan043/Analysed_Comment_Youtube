...
if __name__  =="__main__":
    ...
    data_dir = f"./tmp/flatten_collection_{INDEX_DATA}.json"
    data = load(data_dir)
    print()
    ...
    print("\t\tINIT CHAT")
    api_key_index = 0
    api_key_dir = f"./config/api_key_{INDEX_DATA}"
    client = init_chat(api_key_index, api_key_dir)
    with open(f"./config/api_key_{INDEX_DATA}.json", "r") as f:
    ...
    # Result_dir
    result_dir = f"./tmp/final_data_{INDEX_DATA}.json"
